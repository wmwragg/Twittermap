...
(function (global) {
  ...
  var guid = +new Date,
      ...
      URLS = {
        ...
        timeline: protocol + '//api.twitter.com/1/statuses/user_timeline.json?screen_name=%user%&count=%limit|200%&page=%page|1%&since_id=%since|remove%&max_id=%max|remove%&include_rts=%rts|false%&include_entities=true',
